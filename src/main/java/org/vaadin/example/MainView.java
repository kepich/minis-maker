...
public class MainView extends SplitLayout {
    public MainView(MiniaturesService miniaturesService, PNGBuilderService pngBuilderService, OPRService oprService) {
        PreviewDetails previewDetails = new PreviewDetails(miniaturesService::selected);
        addToPrimary(new ToolbarPanel(miniaturesService, previewDetails, oprService));
